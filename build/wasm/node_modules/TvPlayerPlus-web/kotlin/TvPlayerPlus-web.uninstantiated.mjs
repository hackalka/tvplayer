...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'createTdClient' : (options) => window.createClient(options),
    ...
    const wasmFilePath = './TvPlayerPlus-web.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./TvPlayerPlus-web.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
